...
- Be packed in a container according to guidelines regarding: <!-- "provided by our architects" should eventually be replaced by the content added to these docs. -->
    - Base image
    - Log streams
    - Metrics exposure
